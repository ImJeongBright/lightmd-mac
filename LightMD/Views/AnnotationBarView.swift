...
struct AnnotationBarView: View {
    ...
    var body: some View {
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 8) {
                ...
                .foregroundStyle(viewModel.selectedTextHasAnnotation(.memo) ? colors.accent : colors.secondaryText)
                .help("Memo")
                ...
                .disabled(!hasSelection)
                .buttonStyle(.bordered)
                .foregroundStyle(hasSelection ? Color.red : colors.secondaryText)
    ...
    private func annotationButton(
        ...
        .disabled(!hasSelection)
        .buttonStyle(.bordered)
        .foregroundStyle(isActive ? colors.accent : colors.secondaryText)
        .help(title)
    }
}
